...
import { fetchDataForTableView } from "@/lib/api/user"
import DataTableSearch, { FilterType } from "@/components/ts-table/search"
import { MainTable } from "@/components/ts-table/table"
    ...
    return (
        <div>
            <div className="border-b">
                <div className="container mx-auto">
                    <div className="py-4 mt-4">
                        <h1 className="text-3xl font-semibold">Tanstack Table Drizzle ORM</h1>
            ...
            <div className="container mx-auto py-10">
                <MainTable table={table} isLoading={isLoading} showPagination={true} />
            </div>
        </div>
    )
}
